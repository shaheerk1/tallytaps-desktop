...
const STREAMS = [
  ...
  { entity: 'cash_movement_event', table: 'cash_movement_events' },
  ...
  { entity: 'inventory_allocation_event', table: 'inventory_allocation_events' },
  ...
  { entity: 'customer_advance_receipt', table: 'customer_advance_receipts' },
  { entity: 'customer_advance_payment', table: 'customer_advance_payments', join: 'JOIN customer_advance_receipts p ON p.id=t.advance_receipt_id' },
  { entity: 'customer_advance_refund', table: 'customer_advance_refunds' },
  { entity: 'customer_advance_entry', table: 'customer_advance_entries' },
  { entity: 'invoice_advance_allocation', table: 'invoice_advance_allocations' },
  ...
  { entity: 'supplier_payment', table: 'supplier_payments' },
  { entity: 'fund_account', table: 'fund_accounts' },
  { entity: 'fund_movement', table: 'fund_movements' },
  { entity: 'fund_transfer', table: 'fund_transfers' },
  { entity: 'expense_category', table: 'expense_categories' },
  { entity: 'expense_entry', table: 'expense_entries' },
  { entity: 'expense_allocation', table: 'expense_allocations' },
  { entity: 'expense_reallocation', table: 'expense_reallocations' },
  { entity: 'stakeholder', table: 'stakeholders' },
  { entity: 'stakeholder_share', table: 'stakeholder_shares' },
  { entity: 'stakeholder_ledger_entry', table: 'stakeholder_ledger_entries' },
  { entity: 'ledger_account', table: 'ledger_accounts' },
  { entity: 'journal_entry', table: 'journal_entries' },
  { entity: 'journal_line', table: 'journal_lines' },
  { entity: 'accounting_period', table: 'accounting_periods' },
  { entity: 'accounting_period_event', table: 'accounting_period_events' },
  { entity: 'recurring_expense_template', table: 'recurring_expense_templates' },
  { entity: 'recurring_expense_run', table: 'recurring_expense_runs' },
];
