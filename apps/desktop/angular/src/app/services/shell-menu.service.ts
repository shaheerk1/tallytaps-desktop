...
export class ShellMenuService {
  ...
  private buildCoreMenu(): MenuEntry[] {
    ...
    if (this.session.hasAnyPermission(['supplier-settlements.view', 'supplier-settlements.manage'])) core.push({ id: 'supplier-accounts', label: 'Supplier Accounts', route: '/supplier-accounts', icon: icon('customer_accounts.png'), order: 2.62, core: true });
